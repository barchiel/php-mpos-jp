<div class="row">
  <form class="col-lg-4" action="{$smarty.server.SCRIPT_NAME}" method="POST" role="form">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-envelope fa-fw"></i> 招待
      </div>
      <div class="panel-body">
        ...
        <div class="form-group">
          <label>メッセージ</label>
          <textarea class="form-control" name="data[message]" rows="5">{$smarty.request.data.message|escape|default:"プールへの招待を承認して下さい。"}</textarea>
        </div>
      </div>
      <div class="panel-footer">
        <input type="submit" value="招待" class="btn btn-success btn-sm">
      </div>
    </div>
  </form>
  ...
  <div class="col-lg-8">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-mail-reply fa-fw"></i> 過去の招待
      </div>
      <div class="panel-body">
