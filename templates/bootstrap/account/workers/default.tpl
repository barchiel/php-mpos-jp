<div class="row">
  <form class="col-lg-3" method="POST" role="form">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-plus-square-o fa-fw"></i> 新しいワーカーを追加
      </div>
  ...
  <div class="col-lg-9">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-gears fa-fw"></i> ワーカー設定
      </div>
      <form action="{$smarty.server.SCRIPT_NAME}" method="post" role="form">
		...
		<tr>
		  <td colspan="7">
		    <pre>./minerd -a yescrypt -o stratum+tcp://bitzenypool.work:19666 -u {$username.0|escape}.{$username.1|escape} -p {$WORKERS[worker].password|escape}</pre>
		  </td>
		</tr>
               {/section}
               {/nocache}
          ...
          <div class="panel-footer">
            <input type="submit" class="btn btn-success btn-sm" value="設定を反映">
          </div>
        </div>
      </form>
    </div>
