  ...
  <div class="col-lg-5">
    <form class="panel panel-info" method="post" role="form">
      ...
      <div class="panel-heading">
        <i class="fa fa-edit fa-fw"></i> 新規アカウントの登録
      </div>
      <div class="panel-body">
        <div class="form-group">
          ...
          <label>PINコード</label>
          <font size="1">(4桁の暗証番号) . <b>※重要、各種操作に使用します。</b></font>
          <div class="input-group input-group-sm">
          ...
          <div class="input-group input-group-sm">
            <label>
              <input type="checkbox" value="1" name="tac" id="tac"><a data-toggle="modal" data-target="#TAC">利用規約</a>に同意する。
            </label>
          </div>
        </div>
      ...
      <div class="panel-footer">
        <input type="submit" value="登録" class="btn btn-success btn-sm">
      </div>
    </form>
  </div>
</div>
