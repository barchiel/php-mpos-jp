  ...
  <div class="col-lg-12">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h4 class="panel-title"><i class="fa fa-desktop fa-fw"></i> 最近見つかったブロック</h4>
      </div>
      <div class="panel-body no-padding table-responsive">
        <table class="table table-bordered table-hover table-striped"> 
         <thead>
          <tr>
            <th class="text-right">ブロック</th>
            <th class="text-center">発見者</th>
            <th class="text-right">発見日時</th>
            <th class="text-right">難易度</th>
            <th class="text-right">ZNY数</th>
            <th class="text-right">シェア予想</th>
            <th class="text-right">シェア実績</th>
            <th class="text-right">予測・実績比(%)</th>
          </tr>
          </thead>
          <tbody id="b-blocks">
