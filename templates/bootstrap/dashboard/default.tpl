  ...
  <div class="col-lg-12">
    <div class="panel panel-info">
      ...
      <div class="panel-footer">
        <h6>更新間隔: {$GLOBAL.config.statistics_ajax_refresh_interval|default:"10"} 秒, ワーカーとアカウント {$GLOBAL.config.statistics_ajax_long_refresh_interval|default:"10"} 秒. 過去 {$INTERVAL|default:"5"} 分間のシェアに基づくハッシュレート.</h6>
      </div>
    </div>
  </div>
</div>
